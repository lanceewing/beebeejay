...
/**
 * This class emulators the BBC's memory.
 * 
 * @author Lance Ewing
 */
public class Memory {
  ...
  public Memory(Cpu6502 cpu, Ula ula, Via via, Disk microdisc, Snapshot snapshot) {
    ...
    ula.setMemory(this);
    initBBCMemory(ula, via, microdisc);
  }
  ...
  /**
   * Initialise the BBC's memory.
   * 
   * @param ula The ULA chip to map to memory.
   * @param via The VIA #1 chip to map to memory.
   * @param microdisc The MicroDisc device to map to memory.
   */
  private void initBBCMemory(Ula ula, Via via, Disk microdisc) {
  ...
  /**
   * Gets the int array that represents the BBC's memory.
   * 
   * @return an int array represents the BBC memory.
   */
  ...
  /**
   * Reads the value of the given BBC memory address.
   * 
  ...
  /**
   * Writes a value to the give BBC memory address.
   * 
   * @param address The address to write the value to.
   * @param value The value to write to the given address.
   */
