...
/**
 * Enum representing the different types of keyboard available within BeeBeeJay.
 * 
 * @author Lance Ewing
 */
public enum KeyboardType {
  ...
  /**
   * @return true if this KeyboardType is rendered by the BeeBeeJay render code; otherwise false.
   */
