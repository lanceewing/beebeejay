package emu.bbj.snap;

/**
 * Base class for all machine snapshot formats. The purpose of any subclass is to decode 
 * its format and populate the instance variables shown below.
 * 
 * @author Lance Ewing
 */
