...
import emu.bbj.KeyboardType;
import emu.bbj.MachineScreen;
...
public class MachineInputProcessor extends InputAdapter {
  ...
  /**
   * The one and only ViewportManager used by BeeBeeJay.
   */
  ...
  public boolean keyTyped (char ch) {
    return machineScreen.getMachine().getKeyboard().keyTyped(ch);
  }
  ...
  public boolean touchUp(int screenX, int screenY, int pointer, int button) {
    ...
    } else if (viewportManager.isPortrait() && (touchXY.y > (bbcScreenHeight - 140)) && (touchXY.y < bbcScreenHeight) && (touchXY.x < 140)) {
      // Warp speed icon.
      machineScreen.getMachineRunnable().toggleWarpSpeed();
      
    } else if (viewportManager.isPortrait() && (touchXY.y > (bbcScreenHeight - 140)) && (touchXY.y < bbcScreenHeight) && (touchXY.x > (viewportManager.getWidth() - 145))) {
      // Snapshot.
      machineScreen.getMachineRunnable().pause();
