...
import emu.bbj.memory.MemoryMappedChip;
...
public class Via extends MemoryMappedChip {
  ...
  /**
   * The CPU that the BBC is using. This is where the VIA IRQ signals will be sent.
   */
   ...
   * 
   * @param cpu6502 The CPU that the BBC is using. This is where VIA IRQ signals will be sent.
